    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li ><a href="http://laravel/categories">Категории</a>
                </li>
...
<div class="container">
    <div class="starter-template">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/iPhone_X_64.jpg" alt="iPhone X 256GB">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/HTC_One_S.jpg" alt="HTC One S">
                    <div class="caption">
                        <h3>HTC One S</h3>
                        <p>12490 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/iPhone_5SE.jpg" alt="iPhone 5SE">
                    <div class="caption">
                        <h3>iPhone 5SE</h3>
                        <p>17221 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/Beats_Audio.jpg" alt="Наушники Beats Audio">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/GoPro.jpg" alt="Камера GoPro">
                    <div class="caption">
                        <h3>Камера GoPro</h3>
                        <p>12000 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/Panasonic_HC-V770.jpg" alt="Камера Panasonic HC-V770">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="img/DeLongi.jpg" alt="Кофемашина DeLongi">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="img/Haier.jpg" alt="Холодильник Haier">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="img/Moulinex.jpg" alt="Блендер Moulinex">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="img/Bosch.jpg" alt="Мясорубка Bosch">
                    <div class="caption">
